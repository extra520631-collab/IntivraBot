...
import { startSchema, practiceSchema, answerSchema } from '../validators/interview.schema.js'
import { start, startPractice, answer, finish, frame, voice, myInterviews, hrSchedule, getInterview } from '../controllers/interview.controller.js'
